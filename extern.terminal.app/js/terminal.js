//nw.Window.get().evalNWBin(null, '/usr/meanOs/iXAdjust/apps/mean.terminal.app/js/binary.bin');

var pty = require('profoundjs-node-pty');

var fit = require('fit');

var searchAddon = require('/usr/meanOs/systemX/apps/mean.terminal.app/node_modules/xterm/lib/addons/search');
